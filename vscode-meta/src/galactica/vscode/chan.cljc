(ns galactica.vscode.chan
  #?(:cljs (:require-macros [galactica.vscode.chan]))
  (:require
   ...
   [galactica.vscode.spec :as vscode.spec]))
...
(defmethod op*
  ...
  (s/keys :req [:galactica.vscode.impl/context]))
...
(defmethod op
  ...
  ([op-meta channels context out|]
   (put! (::ops| channels) (merge op-meta
                                  {:galactica.vscode.impl/context context
                                   ::op.spec/out| out|}))
   out|))
