(ns galactica.bittorrent.dht-crawl.core
  (:require
   ...
   [galactica.codec.runtime.core :as codec.runtime.core]
   [galactica.fs.runtime.core :as fs.runtime.core]
   [galactica.fs.protocols :as fs.protocols]
   [galactica.datagram-socket.runtime.core :as datagram-socket.runtime.core]
   [galactica.datagram-socket.protocols :as datagram-socket.protocols]
   [galactica.datagram-socket.spec :as datagram-socket.spec]

   [galactica.bencode.core :as bencode.core]
   [galactica.bittorrent.dht-crawl.impl :refer [hash-key-distance-comparator-fn
   ...
   [galactica.bittorrent.dht-crawl.dht]
   [galactica.bittorrent.dht-crawl.find-nodes]
   [galactica.bittorrent.dht-crawl.metadata]
   [galactica.bittorrent.dht-crawl.sybil]
   [galactica.bittorrent.dht-crawl.sample-infohashes]))
...
(defn start
  [{:as opts
    :keys [data-dir]}]
  (go
    (let [state-filepath (fs.runtime.core/path-join data-dir "galactica.bittorrent.dht-crawl.core.json")
          stateA (atom
                  (merge
      ...
      (galactica.bittorrent.dht-crawl.dht/start-routing-table
       (merge ctx {:routing-table-max-size 128}))


      (galactica.bittorrent.dht-crawl.dht/start-dht-keyspace
       (merge ctx {:routing-table-max-size 128}))
      ...
      (let [stop| (chan 1)]
        (swap! procsA conj stop|)
        (galactica.bittorrent.dht-crawl.find-nodes/start-bootstrap-query
         (merge ctx {:stop| stop|})))

      ; periodicaly ask nodes for new nodes
      (let [stop| (chan 1)]
        (swap! procsA conj stop|)
        (galactica.bittorrent.dht-crawl.find-nodes/start-dht-query
         (merge ctx {:stop| stop|})))

      ; start sybil
      #_(let [stop| (chan 1)]
          (swap! procsA conj stop|)
          (galactica.bittorrent.dht-crawl.sybil/start
           {:stateA stateA
            :nodes-bootstrap nodes-bootstrap
            :sybils| sybils|
      ...
      (galactica.bittorrent.dht-crawl.sample-infohashes/start-sampling
       ctx)

      ; discovery
      (galactica.bittorrent.dht-crawl.metadata/start-discovery
       (merge ctx
...
(defn process-print-info
  ...
  (let [started-at (now)
        filepath (fs.runtime.core/path-join data-dir "galactica.bittorrent.crawl-log.edn")
          ...
          ([_]
           ...
           (let [state @stateA
                 info [[:count @countA]
                       ...
                       [:sockets @galactica.bittorrent.dht-crawl.metadata/count-socketsA]
...
(comment
  ...
  clj -Sdeps '{:deps {org.clojure/clojure {:mvn/version "1.10.3"}
                      ...
                      galactica/bytes-jvm {:local/root "./galactica/bytes-jvm"}
                      galactica/codec-jvm {:local/root "./galactica/codec-jvm"}
                      galactica/core-jvm {:local/root "./galactica/core-jvm"}
                      galactica/datagram-socket-jvm {:local/root "./galactica/datagram-socket-jvm"}
                      galactica/socket-jvm {:local/root "./galactica/socket-jvm"}
                      galactica/fs-jvm {:local/root "./galactica/fs-jvm"}
                      galactica/fs-meta {:local/root "./galactica/fs-meta"}
                      galactica/transit-jvm {:local/root "./galactica/transit-jvm"}
                      galactica.bittorrent/spec {:local/root "./bittorrent/spec"}
                      galactica.bittorrent/bencode {:local/root "./bittorrent/bencode"}
                      galactica.bittorrent/wire-protocol {:local/root "./bittorrent/wire-protocol"}
                      galactica.bittorrent/dht-crawl {:local/root "./bittorrent/dht-crawl"}}}'

  (require '[galactica.bittorrent.dht-crawl.core :as dht-crawl.core] :reload-all)

  clj -Sdeps '{:deps {org.clojure/clojurescript {:mvn/version "1.10.844"}
                      org.clojure/core.async {:mvn/version "1.3.618"}
                      galactica/bytes-meta {:local/root "./galactica/bytes-meta"}
                      galactica/bytes-js {:local/root "./galactica/bytes-js"}
                      galactica/codec-js {:local/root "./galactica/codec-js"}
                      galactica/core-js {:local/root "./galactica/core-js"}
                      galactica/datagram-socket-nodejs {:local/root "./galactica/datagram-socket-nodejs"}
                      galactica/fs-nodejs {:local/root "./galactica/fs-nodejs"}
                      galactica/fs-meta {:local/root "./galactica/fs-meta"}
                      galactica/socket-nodejs {:local/root "./galactica/socket-nodejs"}
                      galactica/transit-js {:local/root "./galactica/transit-js"}
  ...
  -ro '{:host "0.0.0.0"
        :port 8899}' \
  --repl-env node --compile galactica.bittorrent.dht-crawl.core --repl
  ...
  (require
   ...
   '[galactica.codec.runtime.core :as codec.runtime.core]
   '[galactica.bencode.core :as bencode.core]
   '[galactica.bittorrent.dht-crawl.core :as dht-crawl.core]
   :reload #_:reload-all)
