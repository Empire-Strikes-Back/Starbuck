(ns galactica.cljs-self-hosting.core
  (:require
   ...
   [galactica.cljs-self-hosting.spec :as cljs-self-hosting.spec]
   [galactica.cljs-self-hosting.protocols :as cljs-self-hosting.protocols]))
